...
It odes this by automatically converting {dplyr} code into SQL. 
...
for(i in packages_to_install){install.packages(i)}
library(dplyr)
library(highcharter)
library(stringr)
library(tidytext)
...
However 2 strings that are totally unrelated can sometimes have a moderate scores, which could influence the overall match score.
