...
We can use the source() function to load in 3 functions that appear in the {addressMatchR} package, without us having to actually install it. 
...
result_one %>% 
  select(-c(MAX_SCORE, TOKEN_NUMBER))
```
