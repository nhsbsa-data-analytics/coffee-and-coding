...
I've followed [R for Data Science](https://r4ds.had.co.nz/) book chapter 15-17, 20 and [Advanced R book](https://adv-r.hadley.nz/) chapter 9.
...
characters <- map(sw_films, ~ .x[["characters"]] )
...
.x : first object to iterate over
.y : second object to iterate over
...
continent_plots <- map2(.x = data_list_add_col,
     .y = continents,
     .f = ~ ggplot(.x, aes(income, life_exp)) +
       geom_line() +
       labs (title = .y))
