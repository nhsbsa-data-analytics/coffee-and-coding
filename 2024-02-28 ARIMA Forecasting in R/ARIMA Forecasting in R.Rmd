...
Be aware there are other types of transformations which we will not cover in this session and it can be necessary to apply a second round of differencing to your data if it still looks non-stationary after transforming and differencing once. 
...
# ARIMA models in R
In R, the ARIMA models produced are classed as ARIMA(p,d,q) models. Where:

* p is the autoregressive component
