...
This session will follow the process laid out in the book [Forecasting: Principals and Practice](https://otexts.com/fpp3/arima.html). This book goes in to a great amount of detail on modelling and forecasting and I cannot reccomend it enough as a great place to get further information on everything covered in today's session.
