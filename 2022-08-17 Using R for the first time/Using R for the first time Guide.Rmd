...
If you want to change the colour of your bars you can specify the colour this example is for steelblue. Buy using the fill function you can manually select the colour. You can view the colour palette available for ggplot here. https://r-graph-gallery.com/ggplot2-color.html
...
If you want your bars to be different colours you can use the fill option in the code and it will use a default set. There are also different colour palettes available abd you can create your own colour themes.   
