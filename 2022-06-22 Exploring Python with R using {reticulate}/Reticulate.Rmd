...
we have loaded data, for the convinience we just removed all NA values.You can try impute if you wish. 
...
from sklearn.metrics import roc_curve, accuracy_score, classification_report, plot_confusion_matrix
